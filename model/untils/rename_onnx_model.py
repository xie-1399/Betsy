...
'''
here is a rename node script:

example : python3 rename_onnx_model.py --model model.onnx --origin_names x y z --new_names x1 y1 z1 --save_file new_model.onnx
...
def parse_arguments():
    ...
    parser.add_argument('--new_names', required=True, nargs='+', help='The new name you want change to, the number of new_names should be same with the number of origin_names')
