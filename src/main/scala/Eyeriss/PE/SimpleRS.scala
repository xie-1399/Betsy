 ...
 * also the stride is 1
*/

class SimplePE(filterLen:Int,fmapLen:Int,dataWidth:Int) extends Component{
...
class SimplePEArray (filterRowNum:Int,fmapRowNum:Int,
                     filterLen:Int,fmapLen:Int,dataWidth:Int,passFmap:Boolean = true) extends Component{
